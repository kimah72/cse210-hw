...
class Program
{
    static void Main(string[] args)
    {
        ...
        OutdoorGathering outdoorEvent = new OutdoorGathering("Luminaria", "Experience a Beautiful, Winter Light Show", DateTime.Now.AddDays(60), new TimeSpan(21, 0, 0), address1, "Dress for cold weather!");
